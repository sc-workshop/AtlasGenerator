...
namespace sc
{
	namespace AtlasGenerator
	{
		...
		public:
			Config(TextureType type, uint16_t width, uint16_t height, uint8_t scale, uint8_t extrude);
		...
		public:
			...
			virtual uint8_t scale() const { return m_scale_factor; };
